...
public class DragDropCifra {
	...
	// Start the main window and draw the password interface
    public static void main(String[] args) {

        JFrame f=new JFrame("Cifra");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        f.setResizable(false);
        f.getContentPane().setBackground(new Color(22, 24, 27));
        ...
        value.setBackground(new Color(22, 24, 27));   
        ...
        b.setBackground(new Color(94, 186, 125)); 
    ...
    public static void DragDropTestFrame(JFrame f, String pass) {
        ...
        myLabel.setBackground(new Color(0, 0, 0, 0));  
        myLabel.setForeground(new Color(255, 255, 255));
        myLabel.setBounds(-10, -30, 300,300);
...
// Class that creates the drag and drop screen
